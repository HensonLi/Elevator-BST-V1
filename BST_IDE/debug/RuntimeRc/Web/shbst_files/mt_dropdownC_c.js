...
if (childMenuSet == null) childMenuSet = new mtDropDownSet(mtDropDown.direction.right, -5, 2, mtDropDown.reference.topRight);  //×Ó²Ëµ¥
...
'<div class="mtcontent"><table width="115" class="items" cellpadding="0" cellspacing="0" border="0">' + 
