...
#endif
#ifdef LINUX
    #define D_FSRCPATH              QString("/FSRC/")         //>@FLASH中的出厂资源路径
...
//>@默认主题
#define D_HTHEMEDIR         QString("HTHEME/")      //>@存放默认横屏主题
#define D_VTHEMEDIR         QString("VTHEME/")      //>@存放默认竖屏主题

#define D_THEMEDIR          QString("THEME/")       //>@存放所有主题
#define D_EXEDIR            QString("EXE/")         //>@存放所有应用程序
#define D_LOGDIR            QString("LOG/")         //>@存放Log文件
#define D_TMPDIR            QString("TMP/")         //>@存放临时文件
...
#define D_UPGRADELOGODIR    QString("THEME/LOGO/")   //>@U盘目录中的Logo文件目录
#define D_UPGRADEVIDEODIR   QString("THEME/VIDEO/")  //>@U盘目录中的Video文件目录
#define D_UPGRADEIMAGEDIR   QString("THEME/IMAGE/")  //>@U盘目录中的Image文件目录
#define D_UPGRADETEXTDIR    QString("THEME/TEXT/")   //>@U盘目录中的Text文件目录
