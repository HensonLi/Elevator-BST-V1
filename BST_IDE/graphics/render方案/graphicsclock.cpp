...
GraphicsClock::GraphicsClock(QGraphicsItem *parent, QRectF pRect):
...
bool GraphicsClock::InitEffectRc(STATE_INFO* pEffect)
{
    ...
    else if(tmpString.compare(QString("Change"), Qt::CaseInsensitive) == 0)
    {
        ...
        GraphicsBase::analysisEffectPara(tmpAreaAnimate, pEffect->Effect.EffectPara);
...
bool GraphicsClock::analysisEffectParaItem(AREA_ANIMATE* pAreaEffect, QString pLabel, QString pContent)
{
