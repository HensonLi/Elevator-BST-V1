...
#endif
GraphicsSetBar::GraphicsSetBar(QGraphicsItem *parent, QRectF pRect):
...
bool GraphicsSetBar::InitEffectRc(STATE_INFO* pEffect)
{
...
bool GraphicsSetBar::analysisEffectParaItem(AREA_ANIMATE* pAreaEffect, QString pLabel, QString pContent)
{
