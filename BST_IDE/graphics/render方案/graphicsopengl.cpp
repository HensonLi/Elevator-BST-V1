...
GraphicsOpenGL::GraphicsOpenGL(QGraphicsItem *parent, QRectF pRect) :
    GraphicsBase(parent, pRect)
{
    Init3DSPara();
}

bool GraphicsOpenGL::InitEffectRc(STATE_INFO* pEffect)
{
...
bool GraphicsOpenGL::analysisEffectParaItem(AREA_ANIMATE* pAreaEffect, QString pLabel, QString pContent)
{
...
bool GraphicsOpenGL::PaintEffect(QPainter *p)
{
...
DesignOpenGL::DesignOpenGL(QGraphicsItem *parent, QRectF pRect) :
    GraphicsOpenGL(parent, pRect)
{
