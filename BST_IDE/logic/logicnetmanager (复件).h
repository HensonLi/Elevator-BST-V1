...
public:
    ...
    void SyncDev(QIODevice *pIODevice);

    quint32 InitLGPara();
    void UpdateLGPara(QObject* pObject);
    void AppendPHDevices(QStringList pPHDevs);
    ...
    void FrameVerify();
    void NewFrameDetected();  //>@检测到一个新的配置指令
...
public:
    ...
    QByteArray              m_ByteArray, m_DataBuffer, m_FrameBuffer;
...
public:
    ...
    QStringList GetDevInfo(quint64 pLife);
