...
DesignAudio::~DesignAudio()
{
}

bool DesignAudio::InitEffectRc(STATE_INFO* pEffect)
{
...
bool DesignAudio::analysisEffectParaItem(AREA_ANIMATE* pAreaEffect, QString pLabel, QString pContent)
{
    return DesignBase::analysisEffectParaItem(pAreaEffect, pLabel, pContent);
}

bool DesignAudio::Start()
{
...
bool DesignAudio::PaintEffect(QPainter &p)
{
...
void DesignAudio::updateEffect(AREA_OPERATE pOperate, QVariant pPara)
{
